...
def create_disjoint_set_union_jitclass():
    spec = (
        ...
        ('rank', nb.int64[:]),  # rank (or depth) of each tree
    ...
    class DisjointSetUnion:
        def __init__(self, n):
            ...
            for i in range(n):
                ...
                self.rank[i] = 0  # Initial rank is zero.
        ...
        def __str__(self):
            """
            Return a string representation of the DSU's parent and rank arrays.
            """
            s_parent = '['
